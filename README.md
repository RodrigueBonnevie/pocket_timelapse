...
| **[CAMERA-BUILD.md](CAMERA-BUILD.md)** | **Architecture 4 — use an actual camera.** A consumer mirrorless driven over PTP, writing to its own SD card. +3.3 stops of light and 19 stops of exposure range over the module path, and the entire data pipeline disappears. Heat and theft are the risks |
